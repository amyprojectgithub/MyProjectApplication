...
public class OrderMethodUtil {
	public void generatePie(String path,List<Object[]> data) {
		...
		JFreeChart chart=ChartFactory.createPieChart3D("OrderType", dataset, true, true, false);
	...
	public void generateBar(String path,List<Object[]> data) {
		...
		//craete JfreeChart object using ChartFactory
		  JFreeChart chart=ChartFactory.createBarChart("OrderType", "Types", "Count", dataset);
		  //save as image using ChartUtils
		  try {
		  ChartUtils.saveChartAsJPEG(new File(path+"/resources/images/orderBar.jpg"), chart, 450, 400);
		  }catch (IOException e) {
			e.printStackTrace();
		}
	}
