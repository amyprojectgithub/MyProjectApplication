...
public class UomUtil {
	...
	public void generateBar(String path,List<Object[]> data) {
		...
		//craete JfreeChart object using ChartFactory
		  JFreeChart chart=ChartFactory.createBarChart("UomType", "Types", "Count", dataset);
		  //save as image using ChartUtils
		  try {
		  ChartUtils.saveChartAsJPEG(new File(path+"/resources/images/uomBar.jpg"), chart, 450, 400);
		  }catch (IOException e) {
			e.printStackTrace();
		}
	}
